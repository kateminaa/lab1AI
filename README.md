...
**Группа:** 425 Мина, Афанасьева, Семенков, Егорова
...
![Пример графика обучения](plots/example_plot.png)

*Можно добавить больше графиков из папки `plots/` (loss, precision/recall, confusion matrix).*
