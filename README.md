...
3. Провести два типа экспериментов: дообучение предобученной модели и обучение с нуля.
...
- Подходит для дообучения.

### 2.2 Дообучение предобученной модели
- Использование модели, предобученной на ImageNet.  
- Заморозка первых N слоёв или полное дообучение.  
